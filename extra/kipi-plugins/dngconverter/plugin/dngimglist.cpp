...
DNGImagesList::DNGImagesList(Interface *iface, QWidget* parent, int iconSize)
  : ImagesList(iface, parent, iconSize)
{

}

DNGImagesList::~DNGImagesList()
{
}

void DNGImagesList::slotAddItems()
{
    DNGImageDialog dlg(this, iface());
...
DNGImageDialog::~DNGImageDialog()
{
    delete d;
}

KUrl::List DNGImageDialog::urls() const
{
    return d->urls;
}


} // namespace KIPIDNGExportPlugin
